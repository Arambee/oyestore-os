              ...
              {monthChapters.map((c, i) => {
                ...
                >
                  <div className="relative h-56 w-full sm:h-64">
                    ...
                    />
                    <div className={`absolute inset-0 bg-gradient-to-t from-black ${c.soldOut ? "via-black/60" : "via-black/40"} to-black/5`} />
                    <span
                    ...
                    {c.soldOut && (
                      <span className="absolute right-4 top-4 z-10 inline-flex items-center rounded-full bg-[#fffff0]/90 px-3 py-1 text-[11px] font-black tracking-wide text-midnight">
                        SOLD OUT
                      </span>
                    )}
                    <div className="relative flex h-full flex-col justify-end p-5">
                      ...
                      <div className="mt-2 flex items-center justify-between">
                        <span className="text-sm font-semibold text-foreground/90">
                          {c.soldOut ? "Waitlist only" : c.price}
                        </span>
                        <span className="flex items-center gap-1 text-xs font-medium text-foreground/80 transition group-hover:translate-x-1 group-hover:text-foreground">
                          {c.soldOut ? "Join waitlist" : "See the chapter"}
                          <ArrowRight size={14} />
                        </span>
                      </div>
                    </div>
